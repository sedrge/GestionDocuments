// Démarre la connexion OAuth Facebook pour la Page de l'entreprise de l'admin appelant.
// Authentifiée (JWT Supabase requis) — vérifie que l'appelant est bien un
// enterprise_admin avant de générer l'URL du dialogue Facebook.
...
// Signe le paramètre OAuth `state` (HMAC-SHA256) — voir fb-oauth-callback pour la
// vérification symétrique. Dupliqué volontairement dans chaque fonction (plutôt
// qu'un import "../_shared/state.ts") pour rester déployable un fichier à la fois
// depuis l'éditeur web du dashboard Supabase, sans dépendance croisée entre fonctions.
