// app/annees_mois_decharge_new.tsx
...
export default function NewAnneesMoisDechargeScreen() {
  ...
  return (
    ...
    >
      <Stack.Screen options={{ title: "Nouveau Dossier Décharges" }} />
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: "#FF9500", padding: 15, borderRadius: 8, alignItems: "center" },
